...
var pin_mapping_json_1 = __importDefault(require("../resources/pin-mapping.json"));
...
})(CIPTypesValues = exports.CIPTypesValues || (exports.CIPTypesValues = {}));
var PLC = (function (_super) {
    ...
    function PLC(host, options) {
        ...
        else if (typeof host === "string" && !net_1.isIP(host))
    ...
    PLC.prototype.getTagList = function () {
        var _this = this;
        return bluebird_1.default.try(function () { return _super.prototype.acquire.call(_this, function (socket) { return socket.getTagList(); }); });
    };
    ...
    PLC.prototype.setWallClockTime = function (date) {
        return _super.prototype.acquire.call(this, function (socket) {
            return bluebird_1.default.try(function () { return socket.setWallClockTime(date); });
        });
    };
    PLC.discover = function (timeout, options) {
        ...
        return new bluebird_1.default(function (resolve, reject) {
            var request = eip_pool_1.EIPSocket.buildListIdentity();
            var addresses = utils_1.flatten(Object.values(os_1.default.networkInterfaces()))
                .filter(function (i) { return i.family === family && !i.internal; })
                .map(function (i) { return i.address; });
            var _loop_1 = function (ip) {
                var socket = dgram_1.createSocket(__assign({ type: "udp" + family[3] }, socketOptions));
                if (platform !== "linux")
                    socket.bind(0, ip);
                    ...
                    socket.send(request, port, family === "IPv4" ? "255.255.255.255" : "FFFF:FFFF:FFFF", function (err, bytes) {
                        ...
                        socket.on("message", function (msg, rinfo) {
                            ...
                            if (context.toString() === "470018779464") {
                                delete rinfo.size;
                                var device = utils_1.parseIdentityResponse(msg, rinfo);
                                if (device instanceof lgxDevice_1.default && device.IPAddress) {
                                    devices.push(device);
    ...
    PLC.prototype._checkPin = function (pin, value) {
        ...
        if (arguments.length == 2 && typeof value === "undefined") {
            var err = new errors_1.ValueError("Must be pass value to write (false or true) invalid: " + value);
            throw err;
        }
    };
    PLC.prototype._getPinMapping = function (str, pin) {
        ...
        return bluebird_1.default.try(function () {
            if (!_this.replacePin || !_this._pingMapping)
                throw new errors_1.PinMappingError("invalid replacePin or pingMaping, please check, this.replacePin or this.pinMapping");
                ...
                throw new errors_1.PinMappingError("invalid replacePin or pingMaping, please check, this.replacePin");
            }
        });
    };
    ...
    PLC.LogixError = errors_1.LogixError;
    PLC.ValueError = errors_1.ValueError;
    PLC.ConnectionError = errors_1.ConnectionError;
    PLC.ConnectionTimeoutError = errors_1.ConnectionTimeoutError;
    PLC.ConnectionLostError = errors_1.ConnectionLostError;
    PLC.ForwarOpenError = errors_1.ForwarOpenError;
    PLC.RegisterSessionError = errors_1.RegisterSessionError;
    PLC.DisconnectedError = errors_1.DisconnectedError;
